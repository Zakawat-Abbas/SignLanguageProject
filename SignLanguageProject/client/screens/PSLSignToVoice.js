...
export default function PSLSignToVoice() {
    ...
    useEffect(() => {
        const interval = setInterval(async () => {
            ...
            const photo = await cameraRef.current.takePhoto({ quality: 0.5, exif: false });
            ...
            fetch('http://172.20.10.3:4000/predict', {
                method: 'POST',
                headers: {
